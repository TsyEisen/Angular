(function (angular) {
    angular.module('institutionImageApp', ['ngAnimate', 'ngSanitize', 'ui.bootstrap', 'ngFileUpload', 'ui.router'])
   .controller('Inst_imageController', ['$scope', '$window', '$filter', '$state', '$uibModal', 'Upload', 'doctorService',
        function ($scope, $window, $filter, $state, $uibModal, Upload, doctorService) {
            ...
            $scope.NewWindow=function(image) {
                ...
                if (document.body.clientWidth >= document.body.clientHeight) {
                    path = 'http://59.110.29.44/idoctor/html/imageViewer/viewer_landscape.html' + url;
                } else {
                    path = 'http://59.110.29.44/idoctor/html/imageViewer/viewer_vertical.html' + url;
                }
    ...
    .controller('Inst_imageModalInstanceCtrl', ['$scope', '$filter', '$uibModalInstance', 'editImgMessage', 'curpage', 'doctorService',

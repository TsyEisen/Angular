...
(function (angular) {
    angular.module("institution_common_detailsApp",["institutionServiceApp","ui.bootstrap","ngFileUpload"])
        .controller("Inst_common_details",["$scope","institutionService",'Upload', '$timeout',"$uibModal",
            function ($scope,institutionService,Upload,$timeout,$uibModal) {
                ...
                $scope.experthighsearch = function (size) {
                    ...
                    var modalInstance = $uibModal.open({
                        animation: true,
                        templateUrl: 'InstComAsk_ImageModal.html',
                        controller: 'InstComAsk_ImageModalCtrl',
                        backdrop: "static",
                        size: size,
                        resolve: {
                        }
        ...
        .controller("InstComAsk_ImageModalCtrl",["$scope",'$uibModalInstance','institutionService','$uibModalInstance',function ($scope,$uibModalInstance,institutionService,$uibModalInstance) {

 ...
 */
(function (angular) {
    var app = angular.module('institution_todoexpertApp', ['ui.bootstrap']);
    app.controller('institution_expertDetailsController', ['$scope', '$state','$uibModal','doctorService','$filter',function ($scope, $state,$uibModal,doctorService,$filter) {
        $scope.logName = '李晓';

 ...
 */
(function (angular) {
   angular.module('institution_expertApp', ['ngAnimate', 'ngSanitize', 'ui.bootstrap'])
       .controller("institution_expertController",["$scope","institutionService","$uibModal","$state",
           function ($scope,institutionService,$uibModal,$state){
            ...
            // 配置文件中的file_url
               ...
               $scope.jumpToConsult = function () {
                   $state.go("institutionSideBar.institution_expertDetails");
               }
            // 首次进入页面初始化数据

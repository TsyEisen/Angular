(function (angular) {
    var app = angular.module('shareApp', ['ngAnimate', 'ngSanitize', 'ui.bootstrap', 'ui.router']);

    app.controller('shareController', ['$scope', '$state', '$location', '$window', '$state', '$uibModal', 'doctorService',
    ...
    //高级搜索的模态窗口的实例
    app.controller('highSearchModalInstanceCtrl', ['$scope', '$uibModalInstance', 'doctorService',
    ...
    //分享详细模态框实例
    app.controller('changeShareModalInstanceCtrl', ['$scope', '$state', '$window', '$uibModalInstance', 'shareMessage', 'doctorService',
